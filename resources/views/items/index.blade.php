                    ...
                    <tbody class="divide-y divide-slate-100/80 bg-white">
                        @forelse($items as $item)
                            <tr class="transition-colors hover:bg-slate-50/50">
                                ...
                                <td class="px-6 py-4 text-right font-bold text-slate-900">{{ number_format($item->default_price, 2) }}</td>
                            </tr>
                        @empty
                            <tr><td colspan="3" class="px-6 py-12 text-center"><div class="flex flex-col items-center justify-center text-slate-400"><i class="ph ph-package mb-3 text-4xl text-slate-300"></i><p class="text-sm font-medium text-slate-500">No items or services found.</p></div></td></tr>
                        @endforelse
                    </tbody>
                </x-ui.table>
            </div>
